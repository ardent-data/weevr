...
class DimensionMergeBuilder:
    ...
    def build_write_config(self) -> WriteConfig:
        ...
        ``soft_delete_active_value`` are applied.
        ...
        if self._overrides:
            ...
            soft_delete_active_value = self._overrides.soft_delete_active_value
        ...
        return WriteConfig(
            ...
            soft_delete_active_value=soft_delete_active_value,
        )
